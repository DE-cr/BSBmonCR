...
# However, due to the date items' value limitations (top six bits always zero,
# etc.), an erroneous match is unlikely.

printf "%04d-%02d-%02dT%02d:%02d:%02d\n",  # use ISO format for printing
  unpack"nC*", $1;  # get values from pattern found (one word, rest is bytes)
